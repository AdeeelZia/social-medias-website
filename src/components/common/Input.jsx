    ...
    <div className={mainDiv}>
      ...
      <div className="relative w-full">
        <input
          ...
          onChange={onChange}
          className={`py-2 pl-4 pr-10 text-sm border border-[#E3E6EF] outline-none rounded-sm text-[#56565680] w-full ${customClass}`}
        />
        {icon && (
          <svg
